...
set_port_features(SwitchId, PortNo, Features) ->
    ...
    linc_us4_port:set_advertised_features(SwitchId, PortNo, Features2).
...
set_port_config(SwitchId, PortNo, Config) ->
    ...
    linc_us4_port:set_config(SwitchId, PortNo, Config2).
...
set_queue_min_rate(SwitchId, PortNo, QueueId, MinRate) ->
    linc_us4_queue:set_min_rate(SwitchId, PortNo, QueueId, MinRate).
...
set_queue_max_rate(SwitchId, PortNo, QueueId, MaxRate) ->
    linc_us4_queue:set_max_rate(SwitchId, PortNo, QueueId, MaxRate).
